...
def bootstrap(endpoint, public_port, network, dns, directory):
    ...
    with store.db() as con:
        ...
        server = dict(name='wg0', device='eth0', port=1234, private_key=private,
        ...
        defaults = dict(host=endpoint, port=public_port, default_dns=[dns], default_allowed_ips=['0.0.0.0/0'],
...
def main():
    ...
    parser.add_argument('--network', default='10.19.0.0/24')
    parser.add_argument('--dns', default='10.42.42.44')
    ...
    if not args.endpoint:
        parser.error('--endpoint is required for initialization')
