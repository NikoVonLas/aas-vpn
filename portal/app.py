...
def cabinet(request: Request):
    ...
    guide = """<details class='card guide'><summary>Как подключиться</summary><h3>На сайте</h3><p>Введите любое название устройства, например <b>Вася Пупкин</b>, и нажмите <b>«Добавить устройство»</b>. Название нужно только для удобства.</p><h3>В приложении</h3><p>Установите <b>AmneziaWG</b>. Если сайт открыт на другом экране — нажмите <b>QR</b> и отсканируйте код. Если на этом же устройстве — нажмите <b>Файл</b> и откройте скачанные настройки через AmneziaWG.</p></details>"""
