...
: "${PORTAL_ADMIN_PASSWORD:?Set PORTAL_ADMIN_PASSWORD in .env}"
: "${PORTAL_ADMIN_TOTP_SECRET:?Set PORTAL_ADMIN_TOTP_SECRET in .env}"
...
install -m 0644 portal/Dockerfile portal/requirements.txt portal/app.py /opt/aas-vpn/portal/
